...
import Staffbas from './Components/Staffbas';
import Stureg from './Components/Stureg';
import Stubas from './Components/Stubas';
  ...
  <Layout>
        <Routes>
          ...
          <Route path="/Staffprofile" element={<Staffprofile/>} />
           ...
           <Route path="/assignment/:courseId" element={<AssignmentDetail />} />
           <Route path="/assignments/:courseId" element={<Assignment />} />
           <Route path="/reg" element={<Staffreg/>} />
           <Route path="/regg" element={<Staffbas/>} />
           <Route path="/stureg" element={<Stureg/>} />
           <Route path="/sturegg" element={<Stubas/>} />
